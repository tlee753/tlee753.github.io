...
<script>
const wiw = document.getElementsByClassName("post-content")[0].offsetWidth;
const wih = window.innerHeight - 400;

var lossesMargin = {top: 60, right: 30, bottom: 60, left: 60}
var width = wiw - lossesMargin.left - lossesMargin.right
var height = wih - lossesMargin.top - lossesMargin.bottom
...
var lossesSVG = d3.select("#avgLosses")
  ...
  .append("g")
    .attr("transform", `translate( ${lossesMargin.left}, ${lossesMargin.top} )`);
...
d3.csv("/assets/blog/avgLosses.csv").then(function(data) {
    ...
    lossesSVG.selectAll("text")
        .attr("fill", "white");
});

// Wins
var winsMargin = {top: 60, right: 30, bottom: 60, left: 60},
    width = wiw - winsMargin.left - winsMargin.right,
    height = wih - winsMargin.top - winsMargin.bottom;
...
var winsSVG = d3.select("#avgWins")
  ...
  .append("g")
    .attr("transform", `translate( ${winsMargin.left}, ${winsMargin.top} )`);
...
d3.csv("/assets/blog/avgWins.csv").then(function(data) {
    ...
    winsSVG.selectAll("text")
        .attr("fill", "white");
});

// BCS Points
var pointsMargin = {top: 60, right: 30, bottom: 60, left: 60},
    width = wiw - pointsMargin.left - pointsMargin.right,
    height = wih - pointsMargin.top - pointsMargin.bottom;
...
d3.csv("/assets/blog/avgPoints.csv").then(function(data) {
    ...
    pointsSVG.selectAll("text")
        .attr("fill", "white")
        .style("font-family", "Lexend, san-serif");
});

// KEY(s)
var keyMargin = { top: 10, right: 30, bottom: 30, left: 30 },
    width2 = wiw - keyMargin.left - keyMargin.right,
